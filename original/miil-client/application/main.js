...
function setStreamSize() {
  g.column = (app_settings.showBigPhoto == 'y') ? 2 : 2;
  g.marginLeft = (app_settings.showBigPhoto == 'y') ? 2 : 1;
  g.marginRight = (app_settings.showBigPhoto == 'y') ? 2 : 1;
  g.minWidth = (app_settings.showBigPhoto == 'y') ? 193 : 100;
